...
def prepare_dataset(voxel_size):
    ...
    source = o3d.io.read_point_cloud("camera1.pcd")
    target = o3d.io.read_point_cloud("camera2.pcd")
...
def refine_registration(source_down, target_down, source_fpfh, target_fpfh,
    ...
    result = o3d.pipelines.registration.registration_colored_icp(
        ...
        o3d.pipelines.registration.ICPConvergenceCriteria(
            relative_fitness=1e-6, relative_rmse=1e-6, max_iteration=100000))
    return result
